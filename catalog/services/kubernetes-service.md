...
- **`Instance Series`** (select)
  ...
  - when `kubernetesServiceOfferTier` = *Automatic*: All, A-series, Av2 Standard, Basv2-series, Bpsv2-series, Bs-series, Bsv2-series, Da v4-series, Dadsv5-series, Das v4-series, ...
  - when `operatingSystem` = *Windows*: All, A-series, Av2 Standard, Basv2-series, Bs-series, Bsv2-series, Da v4-series, Dadsv5-series, Das v4-series, Dasv5-series, ...
  ...
  - when `category` = *Memory optimized*: All, Constrained vCPUs capable, D-series, DS-series, Dsv2-series, Dv2-series, Ea v4-series, Eadsv5-series, Eas v4-series, Easv5-series, ...
...
- **`Disk size`** (select)
  ...
  - when `managedDiskTier` = *Standard SSD*: E1 - 4 GB, E2 - 8 GB, E3 - 16 GB, E4 - 32 GB, E6 - 64 GB, E10 - 128 GB, E15 - 256 GB, E20 - 512 GB, E30 - 1024 GB, E40 - 2048 GB, ...
