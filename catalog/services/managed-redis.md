...
- **`Instance`** (select)
  ...
  - when `tier` = *Balanced (Memory + Compute)*: B0:  0.5 GB cache, 2 vCPU, B1:  1 GB cache, 2 vCPU, B3:  3 GB cache, 2 vCPU, B5:  6 GB cache, 2 vCPU, B10:  12 GB cache, 4 vCPU, B20:  24 GB cache, 8 vCPU, B50:  60 GB cache, 16 vCPU, B100:  120 GB cache, 32 vCPU, B150:  175 GB cache, 48 vCPU, B250:  235 GB cache, 64 vCPU, ...
  - when `tier` = *Compute Optimized*: X3:  3 GB cache, 4 vCPU, X5:  6 GB cache, 4 vCPU, X10:  12 GB cache, 8 vCPU, X20:  24 GB cache, 16 vCPU, X50:  60 GB cache, 32 vCPU, X100:  120 GB cache, 64 vCPU, X150:  175 GB cache, 96 vCPU, X250:  235 GB cache, 128 vCPU, X350:  360 GB cache, 192 vCPU, X500:  480 GB cache, 256 vCPU, ...
